#!/usr/bin/env python3
"""Merge Kenya temperature NetCDF files into one time-series NetCDF file."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-dir",
        default="data/ethiopia_relative_humidity_mean/netcdf",
    ...
    parser.add_argument(
        "--output",
        default="data/ethiopia_relative_humidity_mean/ethiopia_relative_humidity_mean_merged.nc",
