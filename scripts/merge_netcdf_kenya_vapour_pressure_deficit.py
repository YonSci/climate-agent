#!/usr/bin/env python3
"""Merge Kenya vapour pressure deficit NetCDF files into one time-series NetCDF file."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-dir",
        default="data/kenya_vapour_pressure_deficit/netcdf",
    ...
    parser.add_argument(
        "--output",
        default="data/kenya_vapour_pressure_deficit/kenya_vapour_pressure_deficit_merged.nc",
