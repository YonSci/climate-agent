#!/usr/bin/env python3
"""Merge Ethiopia vapour pressure deficit NetCDF files into one time-series NetCDF file."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-dir",
        default="data/ethiopia_vapour_pressure_deficit/netcdf",
    ...
    parser.add_argument(
        "--output",
        default="data/ethiopia_vapour_pressure_deficit/ethiopia_vapour_pressure_deficit_merged.nc",
