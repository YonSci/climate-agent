#!/usr/bin/env python3
"""Merge Somalia daily temperature NetCDF files into one time-series NetCDF file."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-dir",
        default="data/somalia_temperature/netcdf",
    ...
    parser.add_argument(
        "--output",
        default="data/somalia_temperature/somalia_temperature_merged.nc",
